...
switch($tipoEjemplo)
{
	...
	case 4:
		...
		break;
	case 5:
		//ABRO EL ARCHIVO en modo L/E
		//En caso de no existir el archivo, lo crea. La ruta debe exisitir siempre
		$ar = fopen("archivos2/miArchivo2.txt", "w+");
	...
	case 6:
		...
		//COPIO EN EL ARCHIVO
		//Copia el contenido de un archivo y lo escribe en otro, sobreescribiendo el texto anterior
		//No requiere fopen() ni fclose()
